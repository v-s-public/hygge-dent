...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <script>
            ...
            var mymap = L.map('map', { scrollWheelZoom:false }).setView([47.83040962398523, 35.13672363738203], 17);
            ...
            var marker = L.marker([47.83040962398523, 35.13672363738203]).addTo(mymap);
